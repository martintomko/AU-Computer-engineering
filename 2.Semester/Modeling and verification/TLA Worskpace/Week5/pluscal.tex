...
\begin{document}
\tlatex
\fl{}\moduleLeftDash\cl{ {\MODULE} pluscal}\moduleRightDash\cl{}
\fl{}
\fl{ {\EXTENDS} Naturals ,\, TLC}
\fl{ {\CONSTANT} K}
\fl{}
 \fl{ Divides ( i ,\, j )}\al{5}{6}{ \.{\defeq}}\al{5}{7}{ \E\, k \.{\in} \{ 0
 \.{\dotdot} j \} \.{:} j \.{=} i \.{*} K}
\fl{}
 \fl{ IsGCD ( i ,\, j ,\, k )}\al{7}{8}{ \.{\defeq}}\al{7}{9}{
 \.{\land}}\al{7}{10}{ Divides ( i ,\, j )}
\fl{ \.{\land}}\al{8}{1}{ Divides ( i ,\, k )}
 \fl{ \.{\land}}\al{9}{1}{ \A\, r \.{\in} \{ 0 \.{\dotdot} j \} \.{\cup} \{ 0
 \.{\dotdot} k \} \.{:} Divides ( r ,\, j ) \.{\land} Divides ( r ,\, k )
 \.{\implies} Divides ( r ,\, i )}
\fl{}
\fl{}
\fl{}
